...
public class A_Variable {
	...
	public void findSeasonMenu() {
		...
		System.out.println("1. 한교동 갈릭쉬림프 프레젤(1586)");
		System.out.println("2. 요거 젤리 소다 플랫치노(3900)");
		System.out.println("3. 케로케로피 멜론라떼(4200)");
		...
		// 다음과 같이 출력하시오.
		//
		// 케로케로피 멜론라떼 30잔을 시키셨습니다.
		// (메뉴가격 x 개수)원 입니다.
		
		System.out.println("----------------");
		System.out.println("케로케로피 멜론라떼를 30잔 시키셨습니다");
		System.out.println(3900 * 30 +"원 입니다.");
		...
		System.out.println("딸기라떼 17개를 시켰니?");
	...
	public void declareVariable() {
		 ...
		 *  - 메소드 식별차의 경우 식별자 뒤에 반드시 한 쌍의 "()"를 붙임
		 ...
		 * int 형을 주로 쓰면된다.
		 * long형을 사용할 때에는 대입할 숫자뒤에 "L"을 붙인다.
		 * 
		 * 실수형
		 * 
		 * 실수형에는 2가지 자료형이 존재함
		...
		// 3. (단일) 문자형
		char gold = '밥'; // 2Byte
		// 단일문자에는 반~~~~~~~~~~~~~드시 홀 따옴표를 붙여야됩니다.
		
		//여기까지가 기본자료형 / 원시자료형 8개이다.
		...
		System.out.printf("isTrue라는 변수에 대입한 값: %b, char형은 %c, int형은 %d",isTrue, gold,intNumber);
		...
		System.out.printf("KH 설립연도 : %d",startYear);
		
		final int START_YEAR = 1998;
		// START_YEAR = 2005; 앞에 final이 붙는 순간 상수로 선언하는데, 고칠수없음
