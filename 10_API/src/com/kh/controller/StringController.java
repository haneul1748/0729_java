...
public class StringController {
	 ...
	 * String 클래스 사용방법
	 * 
	 * 1. new 연산자를 사용해서 String클래스의 생성자를 호출하는 방법 2. 대입연산자를 이용해서 문자열 리터럴값을 대입하는 방법
	 */
	...
	public void stringMethod() {
		...
		// => 문자열 beginindex위치에서 문자열 끝까지의 문자열을 추출해서 반환
		...
		// 8. 문자열:toUpperCase() : String -> 싹대 대문자로 바꾸기
		// 문자열:toLowerCase() : String -> 싹대 소문자로 바꾸기
