...
public class PlantController {
	...
	public List<Plant> findByKeword(String keyword) {
		...
		// 조회 => 사용자가 입력한 keword가 포함된 plant객체의 필드값을 확인
