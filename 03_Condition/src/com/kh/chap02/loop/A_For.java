...
public class A_For {
	...
	public void method2() {
		...
		*/
		...
		/*
		Scanner sc = new Scanner(System.in);
		System.out.println("정사각형 찍기를 위한 정수를 입력해주시오. > ");
		int num = sc.nextInt();
		System.out.println("정사각형을 출력하겠습니다.");
	...
	public void method3() {
		for (;;) {
			...
			if(menuNo == 1) {
				...
				System.out.println("구구단을 동작시켜주렴.");
				System.out.println("참 재밌어.");
			} else if (menuNo ==3 ) {
