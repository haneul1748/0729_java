...
public class C_Switch {
	 ...
	 * 	break;
	 * 	case 값3 : 실행할코드n; // 동등비교대상 == 값3 true일 경우 실행할코드 n을 수행
	 *  break;
	 *  default : 실행할코드; // == else
	 * 
	 * }
	...
	public void method1() {
		...
		/*
		switch (menu) {
		case "부찌": System.out.println("부찌의 가격은 11000원입니다."); break;
		case "떡갈비": System.out.println("떡갈비의 가격은 13000원입니다."); break;
		case "제육": System.out.println("제육볶음의 가격은 7000원입니다."); break;
		case "칼국수": System.out.println("칼국수의 가격은 8000원입니다."); break;
		case "수제비": System.out.println("수제비의 가격은 7000원입니다."); break;
	...
	public void login() {
		...
		if(userId.equals(id) && userPwd.equals(password)) {
			System.out.println("로그인성공 ~ " + name + "님 환영합니다 !");
		} else {
