...
import com.kh.chap02.model.vo.RiceWinerDrinker;
...
public class Constructor {
	...
	public static void main(String[] args) {
		...
		RiceWinerDrinker r1 = new RiceWinerDrinker(40);
		RiceWinerDrinker r2 = new RiceWinerDrinker(50);
/*
		s1.drink();
		s2.drink();
		b1.drink();
...
*/
		...
		RiceWinerDrinker [] rwArr = new RiceWinerDrinker[2];
